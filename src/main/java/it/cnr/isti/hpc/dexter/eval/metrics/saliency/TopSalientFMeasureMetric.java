 ...
 */
public class TopSalientFMeasureMetric implements Metric<Double> {

	private final TopSalientPrecisionMetric precisionMetric;
	private final TopSalientRecallMetric recallMetric;

	public TopSalientFMeasureMetric() {
		precisionMetric = new TopSalientPrecisionMetric();
		recallMetric = new TopSalientRecallMetric();
	}
